#!/bin/bash
#
# Git-Go: Interactive Git Repository Setup Script
# Creates new repos or forks existing ones with intelligent sync scripts
# Automatically creates claude.md for AI-assisted development
#
# Usage: ./git-go.sh
#
# ===================================================================================
...
# Claude Instructions for ${repo_name}

This file contains project-specific instructions for Claude AI to assist with development.

## Project Overview
${repo_name} - $([ "$is_fork" = "true" ] && echo "Forked repository" || echo "Original repository")

## Development Guidelines

### Code Style
- Follow existing code conventions in the repository
- Use consistent indentation (check .editorconfig if present)
...
- Run linting/formatting tools before pushing
...
### Architecture Notes
<!-- Describe key architectural decisions, patterns used, etc. -->

### Common Tasks
<!-- List common development tasks and how to approach them -->
...
5. Provide clear explanations for complex changes
...
echo
echo -e "${BLUE}====================================================================================${NC}"
echo -e "${BLUE}                    Git-Go: Repository Setup & Management                          ${NC}"
echo -e "${BLUE}====================================================================================${NC}"
echo
...
if [[ $fork_choice =~ ^[Yy] ]]; then
    ...
    # Create claude.md, sync script and VS Code settings
    create_claude_md "$repo_dir" "$new_repo_name" "true"
...
EOF
    ...
    # Create claude.md
    create_claude_md "$repo_dir" "$new_repo_name" "false"
...
echo -e "${BLUE}📄 Claude instructions: ${repo_dir}/claude.md${NC}"
...
echo -e "  2. Edit claude.md with project-specific instructions"
echo -e "  3. Start working on your project!"
echo -e "  4. Run ${PURPLE}./scripts/git-sync.sh${NC} to sync with remotes"
echo -e "  5. Or use ${PURPLE}Ctrl+Shift+B${NC} in VS Code"

if [[ $fork_choice =~ ^[Yy] ]]; then
    echo -e "  6. Periodically sync to get upstream updates"
fi
...
if command_exists code; then
    ...
    echo -e "  • Edit ${BLUE}claude.md${NC} for AI instructions"
